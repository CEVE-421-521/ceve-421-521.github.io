...
1. @murphy_repetitive:1985 -- "Repetitive Decision Making and the Value of Forecasts in the Cost-Loss Ratio Situation." Introduces the cost-loss framework for quantifying the economic value of weather forecasts, extending from a static to a dynamic (multi-period) setting.
