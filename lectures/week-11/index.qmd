...
:::
::: {.column width="45%"}
![@deneufville_parkinggarage:2006](deneufville_fig3.png)
:::
:::
...
@herman_control:2020 classifies decision support frameworks for water resources planning under climate change into two families:

![@herman_control:2020](herman_fig1.png)
...
From @herman_control:2020.](herman_fig3.png)
...
**Convention:**
actions are chosen *after* observing $\mathbf{x}_t$
...
Solution methods specify *how* to find the best $\pi$
...
## Why Is This Hard? Three Sources of Uncertainty {.smaller}
...
Similar to @srikrishnan_uncertainty:2022 framing, more tailored to water resources.
...
## Solution Method 2: Stochastic Dynamic Programming {.smaller}
...
## Solution Method 3: Direct Policy Search {.smaller}
...
:::
::: {.column width="45%"}
![@garner_slrise:2018](garner_fig3.png){width=70%}
:::
:::
...
## Choosing Indicator Variables {.smaller}
...
:::{#fig-herman-fig6}
![@herman_control:2020](herman_fig6.png){width=90%}
:::
...
**Wednesday:** Fuad leads discussion of @deneufville_parkinggarage:2006.
